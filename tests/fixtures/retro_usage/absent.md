...
║  No Claude Code model usage observed                         ║
║                                                              ║
╚══════════════════════════════════════════════════════════════╝
...
Source: Claude Code session logs; sum of per-machine inventories, not deduplicated (a migrated home directory can be counted twice). Tokens from 0 of 2 machines; newest contributing snapshot unavailable; window 2026-09-07 → 2026-09-14 UTC days; coverage no known token-capture gaps.

- No Claude Code sessions captured in this window.

## Skills used (0 invocations)
- *No fleet device has shipped skill data yet — section omitted (upgrade peers to v0.11.27+ for fleet-wide skill counts).*
