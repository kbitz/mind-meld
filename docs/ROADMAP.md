...
Sequencing: the Execution Map has `Group 13 ← {}` and **no Group depends on 13**; Track 17E merely rebases onto it. Group 14 is the one on the critical path for Groups 16/17/18 and is the more severe bug. **Run Group 14 first.**
