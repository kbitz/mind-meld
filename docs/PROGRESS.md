...
concurrency / correctness sweep), and v0.11.1 (conflict-prompt UX
...
from cli.py). Group 6 (release infrastructure polish — GitHub Releases
backfill) shipped 2026-04-27. Group 7 (mm-events foundation — Tracks 7A
`events.py` foundation + 7B `_push_core` wiring) shipped through v0.10.2 /
v0.10.3. **Group 8 (retro-fleet skill consumer) shipped as v0.11.0 on
