...
- **Named causes instead of a silent gap.** When the block is quiet, `## Notes` says which of no-snapshot / no-reader-enabled / all-stale / nothing-active applies, and what to do about it. A vanished block is never the diagnostic.
